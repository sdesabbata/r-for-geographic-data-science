...
## -2.1894  -0.5726   0.5239   0.6476   2.0282  
## 
## Coefficients:
##             Estimate Std. Error z value Pr(>|z|)    
## (Intercept) -1.21782    0.12790  -9.521   <2e-16 ***
## density_log  1.79797    0.09882  18.195   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for binomial family taken to be 1)
## 
##     Null deviance: 2048.9  on 1667  degrees of freedom
