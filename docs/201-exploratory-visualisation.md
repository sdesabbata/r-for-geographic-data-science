...
As you can see, pie charts are tricky to create using `ggplot2` -- see, for instance, the [ggplot2 pie chart guide](http://www.sthda.com/english/wiki/ggplot2-pie-chart-quick-start-guide-r-software-and-data-visualization) by Statistical tools for high-throughput data analysis (STHDA) for further examples.
