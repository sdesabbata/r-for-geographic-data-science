...
#knitr::include_graphics(paste0(Sys.getenv("RGDS_HOME"), "/src/practicals/images/artificial_neuron.png"))
```
<center>
...
liec_shire_2011OAC <- readr::read_csv(paste0(Sys.getenv("RGDS_HOME"), "/data/", "2011_OAC_Raw_uVariables_Leicestershire.csv"))

unzip(paste0(Sys.getenv("RGDS_HOME"), "/data/", "RUC11_OA11_EW.zip"), exdir = paste0(Sys.getenv("RGDS_HOME"), "/data"))
ru_class_2011 <- readr::read_csv(paste0(Sys.getenv("RGDS_HOME"), "/data/", "RUC11_OA11_EW.csv"))
unlink(paste0(Sys.getenv("RGDS_HOME"), "/data/", "RUC11_OA11_EW.csv"))
```
...
ru_dwellings_nnet_model %>%
  saveRDS(paste0(Sys.getenv("RGDS_HOME"), "/data/", "ru_dwellings_nnet_model.rds"))
```
...
# from data folder
ru_dwellings_nnet_model <-
  readRDS(paste0(Sys.getenv("RGDS_HOME"), "/data/", "ru_dwellings_nnet_model_5_2_001.rds"))
```
